...
WorkingPATH=/home/Dataanalysis/Curations/Metatranscriptomic_PE/Date
...
InputFileExtension_rnaSPAdes_1=_1.fastq.PwU.qtrim.fastq #Forward reads or reaction 1 reads - change "fastq" to "fasta" if you are using "fasta" inputs for Trimmomatic
InputFileExtension_rnaSPAdes_2=_2.fastq.PwU.qtrim.fastq #Reverse reads or reaction 2 reads - change "fastq" to "fasta" if you are using "fasta" inputs for Trimmomatic     
#___________________________________________________________________________________#

#----------------------------- Trimmomatic parameters ------------------------------#

Path_to_adapters=/home/Dataanalysis/Trimmomatic_Adapters
Adapters_file=${Path_to_adapters}/TruSeq2_3-PE.fa 
...
Project_collection=BSF_PE_transcriptomes_by_date
...
echo -e "#----------------------------------------------------------------------#\n#                   3. QC and trimming of reads                        #\n#----------------------------------------------------------------------#\n Project is ${ProjectName}" | tee -a ${Pipeline_Logfile} ${Commands_check_log}
   ...
   then 
      ...
      # To create a string (horizontal list) which has all the sample names with spaces inbetween each name 
      # if you want to do all of this in one line and not have any file remaining afterwards.
      # In this case, it will call the sample name for only the forward or reaction 1 fastq/fasta file, e.g. "Sample_A" from "Sample_A_1.fastq"
      InputShortName=($(sed -e "s+_1.${InputFileExtension_FASTQC_and_Trimmomatic}++g" <(echo $(find ${InputPath1} -type f -name "*_1.${InputFileExtension_FASTQC_and_Trimmomatic}" -printf "%f "))))
      echo "input samples" >> ${Pipeline_Logfile}
      echo "${InputShortName}" >> ${Pipeline_Logfile}
      for Input in ${InputShortName[*]} 
      do 
         ...
         echo "${trimmomaticPROG} PE -threads ${Num_threads} -trimlog ${Trimmomatic_output_directory}/${Input}.logfile -summary ${Trimmomatic_output_directory}/${Input}_statssummary.txt ${InputPath1}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic} ${InputPath1}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic} ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim ILLUMINACLIP:${Adapters_file}:2:30:10 SLIDINGWINDOW:4:5 LEADING:5 TRAILING:5 MINLEN:25" >> ${Commands_check_log}

         ${trimmomaticPROG} PE -threads ${Num_threads} -trimlog ${Trimmomatic_output_directory}/${Input}.logfile -summary ${Trimmomatic_output_directory}/${Input}_statssummary.txt ${InputPath1}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic} ${InputPath1}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic} ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim ILLUMINACLIP:${Adapters_file}:2:30:10 SLIDINGWINDOW:4:5 LEADING:5 TRAILING:5 MINLEN:25
         
         echo "cp ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}${InputFileExtension_rnaSPAdes_1}" >> ${Commands_check_log}
         echo "cp ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}${InputFileExtension_rnaSPAdes_2}" >> ${Commands_check_log}

         cp ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}${InputFileExtension_rnaSPAdes_1}
         cp ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim ${Trimmomatic_output_directory}/${Input}${InputFileExtension_rnaSPAdes_2}
         
         
         mv ${Trimmomatic_output_directory}/${Input}${InputFileExtension_rnaSPAdes_1} ${Trimmomatic_output_directory}/${ProjectName}/${Input}${InputFileExtension_rnaSPAdes_1}
         mv ${Trimmomatic_output_directory}/${Input}${InputFileExtension_rnaSPAdes_2} ${Trimmomatic_output_directory}/${ProjectName}/${Input}${InputFileExtension_rnaSPAdes_2}
         mv ${Trimmomatic_output_directory}/${Input}_statssummary.txt ${Trimmomatic_output_directory}/${ProjectName}/${Input}_statssummary.txt


         echo "rm ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim" >> ${Commands_check_log}
         echo "rm ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim" >> ${Commands_check_log}
         echo "rm ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim" >> ${Commands_check_log}
         echo "rm ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim" >> ${Commands_check_log}
         echo "removing trimmomatic logfiles for each samples for space, but the stats summary files have been kept" >> ${Commands_check_log}
         
         rm ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim
         rm ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.P.qtrim
         rm ${Trimmomatic_output_directory}/${Input}_1.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim
         rm ${Trimmomatic_output_directory}/${Input}_2.${InputFileExtension_FASTQC_and_Trimmomatic}.U.qtrim
         rm *.logfile
...
echo -e "#----------------------------------------------------------------------#\n#                      4. Assembly of contigs                          #\n#----------------------------------------------------------------------#\n Project is ${ProjectName}" | tee -a ${Pipeline_Logfile} ${Commands_check_log}
   ...
   then 
      ...
      # To create a string (horizontal list) which has all the sample names with spaces inbetween each name 
      # if you want to do all of this in one line and not have any file remaining afterwards
      InputShortName=($(sed -e "s+${InputFileExtension_rnaSPAdes_1}++g" <(echo $(find ${InputPath_rnaSPAdes}/${ProjectName} -type f -name "*${InputFileExtension_rnaSPAdes_1}" -printf "%f "))))
      ...
      do 
         ...
         #rnaSPAdes command
         echo "${SPAdesPROG} --rna -m ${Amount_of_RAM} -t ${Num_threads} -1 ${InputPath_rnaSPAdes}/${ProjectName}/${Input}${InputFileExtension_rnaSPAdes_1} -2 ${InputPath_rnaSPAdes}/${ProjectName}/${Input}${InputFileExtension_rnaSPAdes_2} -o ${rnaSPAdes_output_directory}/${ProjectName}/${Input}_rnaSPAdesoutput" >> ${Commands_check_log}

         ${SPAdesPROG} --rna -m ${Amount_of_RAM} -t ${Num_threads} -1 ${InputPath_rnaSPAdes}/${ProjectName}/${Input}${InputFileExtension_rnaSPAdes_1} -2 ${InputPath_rnaSPAdes}/${ProjectName}/${Input}${InputFileExtension_rnaSPAdes_2} -o ${rnaSPAdes_output_directory}/${ProjectName}/${Input}_rnaSPAdesoutput
      ${D_And_T} >> ${Pipeline_Logfile}
      done
   else
