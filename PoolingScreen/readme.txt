...
#  Future updates are likely to contain config files for easier use of the pipeline
  
  
#  The recommended computing resources would be to use a high-resource computing cluster. 16 cores and 300 GB of RAM are a good starting point as the pipeline includes assembly. 
